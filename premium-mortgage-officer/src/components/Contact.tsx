            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:brandon@patriothomemortgage.com" className="text-lg font-semibold text-slate-900 hover:text-blue-700 transition-colors">
                    brandon@patriothomemortgage.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-slate-900">
                    619 S Bluff Street Tower 2 Ste 1B<br />
                    St George, UT 84770
                  </p>
                </div>
              </div>
